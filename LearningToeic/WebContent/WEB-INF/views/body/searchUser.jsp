...
<div class="row">
	<div class="col-lg-12">
		<br />
		<h1 class="page-header">Search User for <strong style="color:red">"${searchKey }"</strong></h1>
	</div>
</div>
<div class="row">
	<div class="col-lg-12">
	...
	<div class="col-lg-12">
		<div>
        	<h4><span class="label label-success">${numUser } results found</span></h4>
        </div><br />
		<form action="searchUser" method="GET">
			<div class="input-group custom-search-form col-lg-5">
				<input type="text" class="form-control" placeholder="Enter Email..." name="searchKey" />
...
<br />
<c:choose>
	<c:when test="${numUser eq 0 }"></c:when>
	<c:otherwise>
<div class="row">
	<div class="col-lg-12">
