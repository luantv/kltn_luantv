<div class="row">
	<div class="col-lg-12">
		<br />
		<h1 class="page-header">Confirm delete lesson "${vocabulary.vocabularyname }"</h1>
	</div>
</div>
...
<img src="${pageContext.request.contextPath}/resources/img/warning-icon.png">
	<div style="display: inline;">
		Are you sure want to delete this lesson? 
			...
			<a href="${pageContext.request.contextPath}/admin/deleteVocabulary?vocabularyid=${vocabulary.vocabularyid}" 
